...
const Dispense_schedule = () => {
    ...
    <div class="container-fluid text-center mt-5">
        <div class="row justify-content-center my-5 ">
            <h1 class="display-6 mb-5">Dispense Schedule</h1>
            <div class="col-md-5 col-sm-8 col-9">
                <div class="card">
                    <div class="card-header">Chart Showing Dispense Schedule</div>
                    <div class="card-header">----------</div>
                    <ul class="list-group list-group-flush">
                        <li id="green" class="list-group-item"> 
                            Dispense on Tuesdays at 8am
                        </li>
                        <li id="yellow" class="list-group-item"> 
                            Dispense on Thursdays at 9am
                        </li>
                        <li id="green" class="list-group-item"> 
                            ----------
                        </li>
...
export default Dispense_schedule;