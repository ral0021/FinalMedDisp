...
const Edit_time_slots = () => {
  ...
  // Function to retrive TimeSlots and set state variable
  async function fetchTimeSlots() {
    const apiData = await API.graphql({ query: listTimeSlotss });
    setTimeSlots(apiData.data.listTimeSlotss.items);
  }

  // Function to create a TimeSlot and save it in the database
  // Removes previous entries for that user
  async function createTimeSlots() {
    ...
    // Loop through entires and remove any that belong to current user
    var timeSlots;
  ...
  // Function to delete a TimeSlot from the database and state variable
